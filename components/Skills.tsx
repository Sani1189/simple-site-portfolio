    ...
    <section className="bg-black dark:bg-gray-900 mx-[5px] rounded-[20px] py-12 sm:py-20 px-[5px] relative -my-10 transition-colors duration-300">
      ...
      <div className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          {/* Section Header */}
          <div className="flex flex-col lg:flex-row justify-between items-start mb-8 sm:mb-12 gap-6 lg:gap-8">
            {/* Left Side - Why Choose Me + Main Heading */}
            <div className="lg:w-1/2 text-center lg:text-left">
              <div className="inline-flex items-center bg-gray-800 dark:bg-gray-700 text-white dark:text-gray-200 px-4 py-2 rounded-full mb-4 sm:mb-6 animate-fadeInUp transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {skills.map((skill, index) => (
              <Card
                key={index}
                className={`bg-gray-900 dark:bg-gray-800 p-4 sm:p-6 lg:p-8 rounded-2xl transition-all duration-500 ease-out cursor-pointer group hover:scale-105 hover:-rotate-[6.74deg] hover:shadow-2xl hover:shadow-lime-400/10 animate-fadeInUp`}
                style={{
              ...
              >
                ...
                <h3
                  className={`font-bold text-white dark:text-gray-100 mb-3 sm:mb-4 transition-colors duration-300 group-hover:text-lime-400 ${
                    skill.isPrimary ? "text-lg sm:text-xl lg:text-2xl" : "text-base sm:text-lg lg:text-xl"
                  }`}
                >
                  {skill.title}
                </h3>
