...
export default function WorkProcess() {
  const processes = [
    ...
    },
    {
      ...
      bgColor: "bg-lime-400 dark:bg-lime-500",
      ...
      <div className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 sm:mb-16 text-center lg:text-left">
            <div className="inline-flex items-center bg-gray-800 dark:bg-gray-700 text-white dark:text-gray-200 px-4 sm:px-6 py-2 sm:py-3 rounded-full mb-6 sm:mb-8 animate-fadeInUp transition-colors duration-300">
              <div className="w-3 h-3 sm:w-4 sm:h-4 rounded-full border border-white dark:border-gray-300 mr-2 sm:mr-3 flex items-center justify-center">
                <svg
              ...
              <span className="text-sm sm:text-base font-medium">Work Process</span>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            {processes.map((process, index) => (
              <Card
                key={index}
                className={`${process.bgColor} p-4 sm:p-6 lg:p-8 rounded-2xl transition-all duration-500 ease-out cursor-pointer group hover:scale-105 hover:-rotate-[6.74deg] hover:shadow-2xl animate-fadeInUp`}
                style={{
              ...
              >
                <div className="flex flex-col sm:flex-row justify-between items-start mb-4 sm:mb-6 gap-4">
                  ...
                  <button
                    className={`${process.textColor === "text-white dark:text-gray-100" ? "text-lime-400 hover:text-lime-300" : "text-black dark:text-white hover:text-gray-700 dark:hover:text-gray-300"} transition-colors duration-300 flex items-center space-x-2 group/btn`}
                  >
                    <span className="text-sm sm:text-base font-medium">Read More</span>
                    <svg
                      className="w-3 h-3 sm:w-4 sm:h-4 group-hover/btn:translate-x-1 transition-transform duration-300"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <p
                  className={`${process.textColor === "text-white dark:text-gray-100" ? "text-gray-300 dark:text-gray-400 group-hover:text-gray-200 dark:group-hover:text-gray-300" : "text-gray-700 dark:text-gray-300 group-hover:text-gray-600 dark:group-hover:text-gray-200"} text-sm sm:text-base lg:text-lg leading-relaxed transition-colors duration-300`}
                >
                  {process.description}
                </p>
              </Card>
